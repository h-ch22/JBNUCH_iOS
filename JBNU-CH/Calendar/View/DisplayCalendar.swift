...
struct DisplayCalendar : UIViewRepresentable, CalendarSeetings{
    ...
    func makeUIView(context: UIViewRepresentableContext<DisplayCalendar>) -> CalendarView {
    ...
    func updateUIView(_ uiView: CalendarView, context: UIViewRepresentableContext<DisplayCalendar>) {
        context.coordinator.events = events
        context.coordinator.type = type
        context.coordinator.updatedDate = updatedDate
    }
    
    func makeCoordinator() -> DisplayCalendar.Coordinator{
        Coordinator(self)
    }
    ...
    class Coordinator: NSObject, CalendarDataSource, CalendarDelegate {
        private var view: DisplayCalendar
