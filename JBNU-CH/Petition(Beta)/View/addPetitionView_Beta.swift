...
struct addPetitionView_Beta: View {
    ...
    @State private var helper = PetitionHelperBeta()
...
struct addPetitionView_Beta_Previews: PreviewProvider {
    static var previews: some View {
        addPetitionView_Beta()
    }
}
